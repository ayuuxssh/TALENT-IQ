...
export async function getMyRecentSessions(req,res){
    ...
    try {
        ...
        console.log("Error in getMyrecent Sessions",error.message);
...
export async function joinSession(req,res){
    try {
        ...
        console.log("Error in join sessions:",error.message);
        res.status(500).json({message:"Internal Server Error"});
...
await channel.delete();
       ...
       res.status(200).json({session,message:"Session end successfully"})
    } catch (error) {
